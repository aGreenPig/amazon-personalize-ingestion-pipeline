...
build:
	...
	aws cloudformation deploy \
		...
		--s3-bucket $(S3_BUCKET) \
		--stack-name personalize-greenpigedu1-ingest-solution \
...
describe:
	@echo "--API URL--"
	@aws cloudformation describe-stacks --stack-name personalize-greenpigedu1-ingest-solution \
